...
public class MapeoCita implements RowMapper<Cita>, MapperResult {
    ...
    public Cita mapRow(ResultSet resultSet, int rowNum) throws SQLException {
        ...
        return Cita.reconstruir(id,fecha,jornada,repositorioAfiliado.obtenerAfiliado(identificacionAfiliado),
                repositorioProcedimiento.obtener(procedimiento),valorCopago,estado);
    }
}
